...
public class MainLayout extends AppLayout implements BeforeEnterObserver {
  ...
  public MainLayout(ChatService service) {
	...
	private SideNav createNavigation() {
		...
		nav.addItem(new SideNavItem("Image-Based Chat", ChatWithImageView.class,
				LineAwesomeIcon.COMMENT_MEDICAL_SOLID.create()));
		nav.addItem(
		...
		nav.addItem(new SideNavItem("Give us a Star ⭐", "https://github.com/ollama4j/ollama4j-web-ui",
